...
const MQTT_BASE_TOPIC = process.env.MQTT_BASE_TOPIC || 'sonos';
const TTS_SAVE_DIR = process.env.TTS_SAVE_DIR || '.cache';
const TTS_HTTP_PORT = process.env.TTS_HTTP_PORT || 8080;
...
const tts = function (text, device) {
    ...
    if (!fs.existsSync(mp3)) {
        ...
        gtts.save(mp3, function (err, result) {
